        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center px-4">
              <div className="w-12 h-12 sm:w-16 sm:h-16 gradient-primary rounded-2xl flex items-center justify-center text-xl sm:text-2xl mx-auto mb-4 sm:mb-6">
                🚀
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">Innovation First</h3>
              <p className="text-sm sm:text-base text-gray-600">
                We're constantly pushing the boundaries of what's possible in remote collaboration.
              </p>
            </div>
            <div className="text-center px-4">
              <div className="w-12 h-12 sm:w-16 sm:h-16 gradient-secondary rounded-2xl flex items-center justify-center text-xl sm:text-2xl mx-auto mb-4 sm:mb-6">
                🌍
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">Global Team</h3>
              <p className="text-sm sm:text-base text-gray-600">
                Our distributed team spans 30+ countries, giving unique insights into remote work.
              </p>
            </div>
            <div className="text-center px-4">
              <div className="w-12 h-12 sm:w-16 sm:h-16 gradient-accent rounded-2xl flex items-center justify-center text-xl sm:text-2xl mx-auto mb-4 sm:mb-6">
                💡
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">User-Centric</h3>
              <p className="text-sm sm:text-base text-gray-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center mb-4">
                <div className="w-8 h-8 sm:w-10 sm:h-10 gradient-primary rounded-xl flex items-center justify-center mr-3">
              ...
              <p className="text-sm sm:text-base text-gray-400 mb-4 sm:mb-6 max-w-md">
                The all-in-one collaboration platform that brings the team together,
                no matter where everyone is in the world.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3">
                ...
                <li><a href="#" className="text-sm sm:text-base text-gray-400 hover:text-white transition-colors">Enterprise</a></li>
                <li><a href="#" className="text-sm sm:text-base text-gray-400 hover:text-white transition-colors">Security</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3">
                ...
                <li><a href="#" className="text-sm sm:text-base text-gray-400 hover:text-white transition-colors">Careers</a></li>
                <li><a href="#" className="text-sm sm:text-base text-gray-400 hover:text-white transition-colors">Blog</a></li>
                <li><a href="#" className="text-sm sm:text-base text-gray-400 hover:text-white transition-colors">Contact</a></li>
              </ul>
            </div>
          </div>
